...
class RegisterTypeModal extends StatefulWidget {
  const RegisterTypeModal({super.key});

  @override
  State<RegisterTypeModal> createState() => _RegisterTypeModalState();
}

class _RegisterTypeModalState extends State<RegisterTypeModal> {
  String selected = 'share';
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  selected == 'exchange'
                      ? '불필요한 내 물건과 다른 사용자가 가진 물건을 교환할 수 있는 기능이에요.'
                      : '나눔은 내 물건을 다른 사람에게 나눠줄 수 있는 기능이에요.\n받음은 다른 사람의 물건을 받을 수 있는 기능이에요.',
                  style: GoogleFonts.pretendard(
                    fontSize: 13,
          ...
          children: [
            ...
            if (isSelected)
              const Padding(
                ...
                child: Icon(Icons.check_circle, size: 18, color: Color(0xFF00C17C)),
              ),
          ],
        ),
      ),
