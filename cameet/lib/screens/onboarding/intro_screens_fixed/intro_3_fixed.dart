...
class IntroShareReceiveScreen extends StatelessWidget {
  const IntroShareReceiveScreen({super.key});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Image.asset('assets/images/intro_share_receive.png', height: 200),
            const Spacer(),
            buildBottomBubble('다음으로 나눔/받음 기능을 소개할게요. 남는 물건은 다른 사용자에게 나눠주거나, 필요한 물건을 요청할 수 있는 기능이에요.'),
          ],
        ),
      ),
    );
